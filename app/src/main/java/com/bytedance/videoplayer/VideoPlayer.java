...
//        path = Environment.getExternalStorageDirectory().getAbsolutePath()+"xxx.mp4";

        String path = Environment.getExternalStorageDirectory().getAbsolutePath()+"/DCIM/Camera/VID_20181210_170534.mp4";
        videoView.setVideoPath(path);

//        videoView.setVideoURI(Uri.parse("https://www.bilibili.com/video/BV1q7411u7u4"));
//        videoView.start();
...
//        videoView.setMediaController(controller);
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (screenOritentation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            //竖屏时处理
            setVideoScreenSize(ViewGroup.LayoutParams.MATCH_PARENT, dip2px(VideoPlayer.this,240));
            screen_flag = true;
